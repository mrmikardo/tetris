...
* [`src/tetris/`](src/tetris/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tetris/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `tetris` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tetris/config.cljs) defaults to `true` in
...
```clj
(ns tetris.example
  (:require [tetris.config :as config])
